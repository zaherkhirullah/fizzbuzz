...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            ...
            <h1 class="ml-2 bg-white">FizzBuzz</h1>
        </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="https://github.com/zaherkhirullah/fizzbuzz"
                               class="underline text-gray-900 dark:text-white">FizzBuzz</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="sm:block mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            @include('code')
                        </div>
                    </div>
                </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="https://zaherr.com" class="ml-1 underline">
                        Zahir Hayrullah
                    </a>
                    ...
                    <a href="https://github.com/zaherkhirullah/fizzbuzz" class="ml-1 underline">
                        Github
                    </a>
